// Scene graph node and component base, reconstructed from Node.cpp (0x080d8f20-0x080daea0).
// Node layout: name, parent/next/prev/firstChild/lastChild links, local matrix, cached
// local-to-world and world-to-local matrices, three component slots, cached entity
// pointers, owning scene and spatial node.
#pragma once
...
class Component
{
  public:
    ...
    virtual ~Component() {}
    // 0x080d7290 / 0x080d72a0: no-ops in the base.
...
class Node
{
  public:
    ...
    virtual ~Node();
    // Called whenever the world transform of this node changes.
    ...
    {
        return m_pMeshEntity;
    }
    LightEntity* getLightEntity() const
    {
        return m_pLightEntity;
    }
