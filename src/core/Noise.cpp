...
// (512 entries at 0x08235ca0). The original truncates coordinates with x87 rounding
// (round-to-nearest), which lrint() reproduces.
...
{
    int xi = (int)lrintf(xf), yi = (int)lrintf(yf);
...
{
    int xi = (int)lrintf(xf), yi = (int)lrintf(yf), zi = (int)lrintf(zf);
